Describe 'Delete large bucket 100:' category:"Bucket Management"
  setup(){
  ...
  Example "on profile $1 using client $2" id:"093"
    ...
    "aws-s3api" | "aws" | "aws-s3")
      ...
      echo "Time to remove bucket with $files_count files on profile $profile: $remove_bucket_time seconds" >> ./report/teste.txt
...
Describe 'Delete large bucket 1000:' category:"Bucket Management"
  setup(){
    bucket_name="test-093-$(date +%s)"
    file1_name="LICENSE"
    files_count=1000
...
Describe 'Delete large bucket 10000:' category:"Bucket Management"
  setup(){
    bucket_name="test-093-$(date +%s)"
    file1_name="LICENSE"
    files_count=10000
...
Describe 'Delete large bucket 100000:' category:"Bucket Management"
  setup(){
    bucket_name="test-093-$(date +%s)"
    file1_name="LICENSE"
    files_count=10000
