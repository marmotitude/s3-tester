...
RUN apt update && apt install -y \
    ca-certificates jq bc openssl curl python3 python3-pip less python3-venv
...
# pandas (already installed in venv, no need for system-wide install)
